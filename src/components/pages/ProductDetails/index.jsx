...
<div className="container flex gap-4">
    ...
    <div className="Product-content  w-[60%] ">
      <h1 className="text-[20px] font-[600]">THE heading name for product</h1>
      <div className=" flex items-center gap-3">
       <span className="text-gray-600 py-2 ">Brands : 
          <span className="text-[15px] font-[700px] pl-2 text-black">The Brand Name </span>
       </span>
  ...
  <p className="text-[14px] mt-4 mb-2">Free Shipping(Est. Delivery 2 to 3 days )</p>
   <div className="flex items-center gap-3">
    <div className="qtyBoxWrapper">
      <QtyBox/>
    </div>
    <button className="flex items-center h-[30px] bg-red-600 text-white py-2 px-4 rounded gap-2  hover:bg-black transition duration-300">
